#ifndef TERMINAL_RVIZ_DISPLAYS_POINT_STAMPED_HPP_
#define TERMINAL_RVIZ_DISPLAYS_POINT_STAMPED_HPP_
...
class PointStampedDisplay : public Display {
public:
    explicit PointStampedDisplay(rclcpp::Node::SharedPtr node);
    ...
    std::string getMessageType() const override { return "geometry_msgs/msg/PointStamped"; }

private:
    void callback(const geometry_msgs::msg::PointStamped::SharedPtr msg, const std::string& topic);

    std::map<std::string, rclcpp::Subscription<geometry_msgs::msg::PointStamped>::SharedPtr> subs_;
    std::map<std::string, geometry_msgs::msg::PointStamped::SharedPtr> latest_msgs_;
...
#endif // TERMINAL_RVIZ_DISPLAYS_POINT_STAMPED_HPP_

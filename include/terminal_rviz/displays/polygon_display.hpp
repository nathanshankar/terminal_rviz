#ifndef TERMINAL_RVIZ_DISPLAYS_POLYGON_HPP_
#define TERMINAL_RVIZ_DISPLAYS_POLYGON_HPP_
...
public:
    explicit PolygonDisplay(rclcpp::Node::SharedPtr node);
    ...
    std::string getMessageType() const override { return "geometry_msgs/msg/PolygonStamped"; }

private:
    void callback(const geometry_msgs::msg::PolygonStamped::SharedPtr msg, const std::string& topic);

    std::map<std::string, rclcpp::Subscription<geometry_msgs::msg::PolygonStamped>::SharedPtr> subs_;
    std::map<std::string, geometry_msgs::msg::PolygonStamped::SharedPtr> latest_msgs_;
...
#endif // TERMINAL_RVIZ_DISPLAYS_POLYGON_HPP_

#ifndef TERMINAL_RVIZ_DISPLAYS_WRENCH_HPP_
#define TERMINAL_RVIZ_DISPLAYS_WRENCH_HPP_
...
class WrenchDisplay : public Display {
public:
    explicit WrenchDisplay(rclcpp::Node::SharedPtr node);
    ...
    std::string getMessageType() const override { return "geometry_msgs/msg/WrenchStamped"; }

private:
    void callback(const geometry_msgs::msg::WrenchStamped::SharedPtr msg, const std::string& topic);

    std::map<std::string, rclcpp::Subscription<geometry_msgs::msg::WrenchStamped>::SharedPtr> subs_;
    std::map<std::string, geometry_msgs::msg::WrenchStamped::SharedPtr> latest_msgs_;
...
#endif // TERMINAL_RVIZ_DISPLAYS_WRENCH_HPP_

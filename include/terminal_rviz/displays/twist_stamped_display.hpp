#ifndef TERMINAL_RVIZ_DISPLAYS_TWIST_STAMPED_HPP_
#define TERMINAL_RVIZ_DISPLAYS_TWIST_STAMPED_HPP_
...
class TwistStampedDisplay : public Display {
public:
    explicit TwistStampedDisplay(rclcpp::Node::SharedPtr node);
    ...
    std::string getMessageType() const override { return "geometry_msgs/msg/TwistStamped"; }

private:
    void callback(const geometry_msgs::msg::TwistStamped::SharedPtr msg, const std::string& topic);

    std::map<std::string, rclcpp::Subscription<geometry_msgs::msg::TwistStamped>::SharedPtr> subs_;
    std::map<std::string, geometry_msgs::msg::TwistStamped::SharedPtr> latest_msgs_;
...
#endif // TERMINAL_RVIZ_DISPLAYS_TWIST_STAMPED_HPP_

#ifndef TERMINAL_RVIZ_DISPLAYS_POSE_WITH_COVARIANCE_HPP_
#define TERMINAL_RVIZ_DISPLAYS_POSE_WITH_COVARIANCE_HPP_
...
class PoseWithCovarianceDisplay : public Display {
public:
    explicit PoseWithCovarianceDisplay(rclcpp::Node::SharedPtr node);
    ...
    std::string getMessageType() const override { return "geometry_msgs/msg/PoseWithCovarianceStamped"; }

private:
    void callback(const geometry_msgs::msg::PoseWithCovarianceStamped::SharedPtr msg, const std::string& topic);

    std::map<std::string, rclcpp::Subscription<geometry_msgs::msg::PoseWithCovarianceStamped>::SharedPtr> subs_;
    std::map<std::string, geometry_msgs::msg::PoseWithCovarianceStamped::SharedPtr> latest_msgs_;
...
#endif // TERMINAL_RVIZ_DISPLAYS_POSE_WITH_COVARIANCE_HPP_
